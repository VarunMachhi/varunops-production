...
Write-Host ''
Write-Host 'VarunOps Agent 4.4.0 - Automatic Update / Repair' -ForegroundColor Cyan
...
Copy-Item $config (Join-Path $dir 'agent.json.before-4.4.0.bak') -Force
...
Write-Host '[1/3] Agent 4.4.0 files upgraded.' -ForegroundColor Green
...
Write-Host ''
Write-Host 'SUCCESS: Agent 4.4.0 synced. Future agent upgrades are automatic from the VarunOps server.' -ForegroundColor Green

...
3. Existing PCs: download the latest connector from the employee portal and run `UPDATE_EXISTING_AGENT.bat` as Administrator so Agent 4.3.0 receives Strict Browsing Lock support.

...
urlpatterns = [
    ...
    path("network-policies/<int:policy_id>/toggle/", views.admin_network_policy_toggle, name="admin_network_policy_toggle"),
    path("network-policies/<int:policy_id>/delete/", views.admin_network_policy_delete, name="admin_network_policy_delete"),
